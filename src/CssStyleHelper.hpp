...
[[ noreturn ]] void addCssStyle(client::ElementCSSInlineStyle* element, CSSStyleHelper cssEnumValue, client::String* value)
{
    switch (cssEnumValue)
    {
        ...
        case CSSStyleHelper::ColumnCount:                       { element->get_style()->set_columnCount(value);                     }   break;
        case CSSStyleHelper::ColumnFill:                        { element->get_style()->set_columnFill(value);                      }   break;
        case CSSStyleHelper::ColumnGap:                         { element->get_style()->set_columnGap(value);                       }   break;
        case CSSStyleHelper::ColumnRule:                        { element->get_style()->set_columnRule(value);                      }   break;
        case CSSStyleHelper::ColumnRuleColor:                   { element->get_style()->set_columnRuleColor(value);                 }   break;
        case CSSStyleHelper::ColumnRuleStyle:                   { element->get_style()->set_columnRuleStyle(value);                 }   break;
        case CSSStyleHelper::ColumnRuleWidth:                   { element->get_style()->set_columnRuleWidth(value);                 }   break;
        case CSSStyleHelper::ColumnSpan:                        { element->get_style()->set_columnSpan(value);                      }   break;
        case CSSStyleHelper::ColumnWidth:                       { element->get_style()->set_columnWidth(value);                     }   break;
        ...
        case CSSStyleHelper::MsContentZoomLimitMax:             { element->get_style()->set_msContentZoomLimitMax(value);           }   break;
        case CSSStyleHelper::MsContentZoomLimitMin:             { element->get_style()->set_msContentZoomLimitMin(value);           }   break;
        ...
        case CSSStyleHelper::MsGridColumn:                      { element->get_style()->set_msGridColumn(value);                    }   break;
        case CSSStyleHelper::MsGridColumnAlign:                 { element->get_style()->set_msGridColumnAlign(value);               }   break;
        case CSSStyleHelper::MsGridColumnSpan:                  { element->get_style()->set_msGridColumnSpan(value);                }   break;
        case CSSStyleHelper::MsGridColumns:                     { element->get_style()->set_msGridColumns(value);                   }   break;
        case CSSStyleHelper::MsGridRow:                         { element->get_style()->set_msGridRow(value);                       }   break;
        case CSSStyleHelper::MsGridRowAlign:                    { element->get_style()->set_msGridRowAlign(value);                  }   break;
        case CSSStyleHelper::MsGridRowSpan:                     { element->get_style()->set_msGridRowSpan(value);                   }   break;
        ...
        case CSSStyleHelper::MsHyphenateLimitLines:             { element->get_style()->set_msHyphenateLimitLines(value);           }   break;
        case CSSStyleHelper::MsHyphenateLimitZone:              { element->get_style()->set_msHyphenateLimitZone(value);            }   break;
        ...
        case CSSStyleHelper::MsScrollLimitXMax:                 { element->get_style()->set_msScrollLimitXMax(value);               }   break;
        case CSSStyleHelper::MsScrollLimitXMin:                 { element->get_style()->set_msScrollLimitXMin(value);               }   break;
        case CSSStyleHelper::MsScrollLimitYMax:                 { element->get_style()->set_msScrollLimitYMax(value);               }   break;
        case CSSStyleHelper::MsScrollLimitYMin:                 { element->get_style()->set_msScrollLimitYMin(value);               }   break;
        ...
        case CSSStyleHelper::MsTextSizeAdjust:                  { element->get_style()->set_msTextSizeAdjust(value);                }   break;
        ...
        case CSSStyleHelper::MsWrapMargin:                      { element->get_style()->set_msWrapMargin(value);                    }   break;
        ...
        case CSSStyleHelper::WebkitColumnCount:                 { element->get_style()->set_webkitColumnCount(value);               }   break;
        case CSSStyleHelper::WebkitColumnGap:                   { element->get_style()->set_webkitColumnGap(value);                 }   break;
        case CSSStyleHelper::WebkitColumnRule:                  { element->get_style()->set_webkitColumnRule(value);                }   break;
        case CSSStyleHelper::WebkitColumnRuleColor:             { element->get_style()->set_webkitColumnRuleColor(value);           }   break;
        case CSSStyleHelper::WebkitColumnRuleStyle:             { element->get_style()->set_webkitColumnRuleStyle(value);           }   break;
        case CSSStyleHelper::WebkitColumnRuleWidth:             { element->get_style()->set_webkitColumnRuleWidth(value);           }   break;
        case CSSStyleHelper::WebkitColumnSpan:                  { element->get_style()->set_webkitColumnSpan(value);                }   break;
        case CSSStyleHelper::WebkitColumnWidth:                 { element->get_style()->set_webkitColumnWidth(value);               }   break;
        ...
        case CSSStyleHelper::WebkitTextsizeAdjust:              { element->get_style()->set_webkitTextSizeAdjust(value);            }   break;
